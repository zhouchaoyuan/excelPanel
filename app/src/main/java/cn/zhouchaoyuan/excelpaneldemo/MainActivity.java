        ...
        public void onClick(View view) {
            ...
            if (cell != null) {
                if (cell.getStatus() == 0) {
                    ...
                    Toast.makeText(MainActivity.this, "已离店，离店人：" + cell.getBookingName(), Toast.LENGTH_SHORT).show();
                } else if (cell.getStatus() == 2) {
                    Toast.makeText(MainActivity.this, "入住中，离店人：" + cell.getBookingName(), Toast.LENGTH_SHORT).show();
                } else if (cell.getStatus() == 3) {
                    Toast.makeText(MainActivity.this, "预定中，离店人：" + cell.getBookingName(), Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
